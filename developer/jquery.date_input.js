...
DateInput.prototype = {
  build: function() {
    var monthNav = $('<p class="month_nav">' +
      '<span class="button prev glyphicon glyphicon-chevron-left" title="[Page-Up]"></span>' +
      ' <span class="month_name"></span> ' +
      '<span class="button next glyphicon glyphicon-chevron-right" title="[Page-Down]"></span>' +
      '</p>');
    ...
    var yearNav = $('<p class="year_nav">' +
      '<span class="button prev glyphicon glyphicon-chevron-left" title="[Ctrl+Page-Up]"></span>' +
      ' <span class="year_name"></span> ' +
      '<span class="button next glyphicon glyphicon-chevron-right" title="[Ctrl+Page-Down]"></span>' +
      '</p>');
