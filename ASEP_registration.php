    ...
    <div class="row">
        ...
        <script type="text/javascript">
            ...
            function resizeImage(){
                if(($('#stock-image-image').height() > $("#main-content").height()) && ($(window).width() >= 768)){
                    var aspectRatio = $('#stock-image-image').width() / $('#stock-image-image').height();
                    $('#stock-image-image').height($("#main-content").height());
                    $('#stock-image-image').width($("#main-content").height()*aspectRatio);
                }
            }
